...
@Configuration
@EnableJpaRepositories(basePackages = "com.albo.dao.compusoft", entityManagerFactoryRef = "compusoftEntityManagerFactory", transactionManagerRef = "compusoftTransactionManager")
