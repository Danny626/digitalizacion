...
@NamedQueries({ @NamedQuery(name = "Ubicacion.findAll", query = "SELECT u FROM Ubicacion u") })
public class Ubicacion implements Serializable {
	...
	public String toString() {
		return "com.albo.model.soa.Ubicacion[ ubicacionPK=" + ubicacionPK + " ]";
	}
